...
class InvertedBottleneck(nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int, 
                 expansion: int = 6, kernel_size: int = 3):
        super().__init__()
...
OPS = {
    ...
    'sep_conv_3x3': lambda C, stride: SeparableConv2d(C, C, 3, stride=stride, padding=1),
    'sep_conv_5x5': lambda C, stride: SeparableConv2d(C, C, 5, stride=stride, padding=2),
    'sep_conv_7x7': lambda C, stride: SeparableConv2d(C, C, 7, stride=stride, padding=3),
