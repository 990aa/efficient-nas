...
class DatasetManager:
    ...
    def get_cifar10_loaders(
        self, batch_size: int = 96, cutout: bool = False
        ...
        train_dataset = torchvision.datasets.CIFAR10(
            root=self.data_root, train=True, download=True, transform=search_transform
        )

        test_dataset = torchvision.datasets.CIFAR10(
            root=self.data_root, train=False, download=True, transform=eval_transform
        )
    ...
    def get_imagenet16_120_loaders(
